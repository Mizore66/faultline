...
Pinned recording checkout: `git checkout v0.1.6-buildweek`. Teleprompter: [video-teleprompter.md](video-teleprompter.md).
...
| Pinned submission checkout | README + `package-smoke` pin | `v0.1.6-buildweek` |
