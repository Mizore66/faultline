...
## Never say these unless the exact artifact is on screen
...
- [ ] Confirm green CI / provenance for commit `ce99a793…` (Actions run URL + screenshot) — do not rely only on a badge
