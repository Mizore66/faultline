...
.compact-section{min-height:100vh;min-height:100svh;display:flex;flex-direction:column;justify-content:flex-start;padding:112px 0}
.find-version-section{justify-content:flex-start;padding-top:112px}
